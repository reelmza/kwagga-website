...
export function EmailLink({
  ...
  return (
    <a
      ...
      className="border-b-2 border-accent px-1 pb-1 text-[clamp(20px,2.6vw,34px)] font-semibold tracking-[-0.02em] text-ink no-underline transition-colors duration-300 hover:bg-accent hover:text-on-accent"
    >
